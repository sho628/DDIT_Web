...
<form id="repInsertForm" action="${cPath }/reply/replyInsert.do" method="post">
	...
	<input type="text" class="form-control cols"  name="repWriter" placeholder="작성자" required />
	<input type="text" class="form-control cols"  name="repPass" placeholder="비밀번호" required />
	<input type="text" class="form-control cols"  name="repMail" placeholder="이메일" /><br />
	</div>
	<div class="form-group">
		<textarea class="form-control"  rows="3" cols="90" name="repContent" placeholder="내용"></textarea>
